...
- Explore core features of JavaScript language: data types, variables, operators
- Conclusion, final questions

## Lesson

Total time: ~2.5 hours  
Presentation: [slides][s1-slides] | [source file](slides.md)
...
- Introduction & Orientation (50 min)
  - Introduce self
...
- The Building Blocks of JavaScript (60 min)
